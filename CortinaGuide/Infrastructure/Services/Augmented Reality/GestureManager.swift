...
struct GestureTypes: OptionSet {
    ...
    static let tap           = GestureTypes(rawValue: 1 << 1)
    static let doubleTap     = GestureTypes(rawValue: 1 << 2)
    static let longPress     = GestureTypes(rawValue: 1 << 3)
    static let pinch         = GestureTypes(rawValue: 1 << 4)
    static let pan           = GestureTypes(rawValue: 1 << 5)
    static let rotation      = GestureTypes(rawValue: 1 << 6)
